...
DEFINE_INDEPENDENT_EVENTHANDLER( S2_Rxi_Selector, 00000 /*Select*/ )
    ...
    if ( (Nvram->S2_Rxi_Selector.__RXI_01_ON == 1)) 
        { 
        UpdateSourceCodeLine( INSTANCE_PTR( S2_Rxi_Selector ), 28 );
        SetAnalog ( INSTANCE_PTR( S2_Rxi_Selector ), __S2_Rxi_Selector_SELECTEDOUTPUT_ANALOG_OUTPUT, GetIntegerParameter( INSTANCE_PTR( S2_Rxi_Selector ), __S2_Rxi_Selector_RXI02OUTPUT_INTEGER_PARAMETER ) ) ; 
        UpdateSourceCodeLine( INSTANCE_PTR( S2_Rxi_Selector ), 29 );
        SetAnalog ( INSTANCE_PTR( S2_Rxi_Selector ), __S2_Rxi_Selector_SELECTEDINPUT_ANALOG_OUTPUT, GetIntegerParameter( INSTANCE_PTR( S2_Rxi_Selector ), __S2_Rxi_Selector_RXI02INPUT_INTEGER_PARAMETER ) ) ; 
        UpdateSourceCodeLine( INSTANCE_PTR( S2_Rxi_Selector ), 30 );
        Nvram->S2_Rxi_Selector.__RXI_01_ON = 0; 
        } 
        ...
        Nvram->S2_Rxi_Selector.__RXI_01_ON = 1; 
        } 
...
DEFINE_INDEPENDENT_EVENTHANDLER( S2_Rxi_Selector, 00001 /*ResetRxi*/ )
...
static void ProcessDigitalEvent( struct Signal_s *Signal )
{
    switch ( Signal->SignalNumber )
    {
        ...
        case __S2_Rxi_Selector_RESETRXI_DIG_INPUT :
            if ( Signal->Value /*Push*/ )
            {
                SAFESPAWN_EVENTHANDLER( S2_Rxi_Selector, 00001 /*ResetRxi*/, 0 );
