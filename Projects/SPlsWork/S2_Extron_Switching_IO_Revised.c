...
DEFINE_INDEPENDENT_EVENTHANDLER( S2_Extron_Switching_IO_Revised, 00000 /*Source*/ )
    ...
    Nvram->S2_Extron_Switching_IO_Revised.__IN = GetAnalogInput( INSTANCE_PTR( S2_Extron_Switching_IO_Revised ), __S2_Extron_Switching_IO_Revised_SOURCE_ANALOG_INPUT ); 
    UpdateSourceCodeLine( INSTANCE_PTR( S2_Extron_Switching_IO_Revised ), 21 );
    if ( (((GetDigitalInput( INSTANCE_PTR( S2_Extron_Switching_IO_Revised ), __S2_Extron_Switching_IO_Revised_ENABLE_DIG_INPUT ) && (Nvram->S2_Extron_Switching_IO_Revised.__OUT > 0)) && (Nvram->S2_Extron_Switching_IO_Revised.__OUT <= 32)) && (Nvram->S2_Extron_Switching_IO_Revised.__IN <= 32))) 
        { 
        ...
        SetSerial( INSTANCE_PTR( S2_Extron_Switching_IO_Revised ), __S2_Extron_Switching_IO_Revised_EXTRON_TX_STRING_OUTPUT, GENERIC_STRING_OUTPUT( S2_Extron_Switching_IO_Revised ) );
...
DEFINE_INDEPENDENT_EVENTHANDLER( S2_Extron_Switching_IO_Revised, 00001 /*Dest*/ )
    ...
    Nvram->S2_Extron_Switching_IO_Revised.__OUT = GetAnalogInput( INSTANCE_PTR( S2_Extron_Switching_IO_Revised ), __S2_Extron_Switching_IO_Revised_DEST_ANALOG_INPUT ); 
    UpdateSourceCodeLine( INSTANCE_PTR( S2_Extron_Switching_IO_Revised ), 30 );
    if ( ((((GetDigitalInput( INSTANCE_PTR( S2_Extron_Switching_IO_Revised ), __S2_Extron_Switching_IO_Revised_ENABLE_DIG_INPUT ) && (Nvram->S2_Extron_Switching_IO_Revised.__IN > 0)) && (Nvram->S2_Extron_Switching_IO_Revised.__OUT != Nvram->S2_Extron_Switching_IO_Revised.__PREV_OUT)) && (Nvram->S2_Extron_Switching_IO_Revised.__OUT <= 32)) && (Nvram->S2_Extron_Switching_IO_Revised.__IN <= 32))) 
        { 
...
static void ProcessAnalogEvent( struct Signal_s *Signal )
{
    switch ( Signal->SignalNumber )
    {
        case __S2_Extron_Switching_IO_Revised_SOURCE_ANALOG_INPUT :
            SAFESPAWN_EVENTHANDLER( S2_Extron_Switching_IO_Revised, 00000 /*Source*/, 0 );
            break;
            
        case __S2_Extron_Switching_IO_Revised_DEST_ANALOG_INPUT :
            SAFESPAWN_EVENTHANDLER( S2_Extron_Switching_IO_Revised, 00001 /*Dest*/, 0 );
            break;
